...
class Acaldeira_Wholesaler_Adminhtml_Sales_Order_ShipmentController extends Mage_Adminhtml_Sales_Order_ShipmentController
{
	...
	public function newAction()
	{
		if ($shipment = $this->_initShipment()) {
			...
			$this->_redirect('*/adminhtml_sales_order/view', array('order_id'=>$this->getRequest()->getParam('order_id')));
		}
	}
	...
	public function saveAction()
	{
		...
		if ($isNeedCreateLabel) {
			...
			$this->_redirect('*/adminhtml_sales_order/view', array('order_id' => $shipment->getOrderId()));
		}
	}

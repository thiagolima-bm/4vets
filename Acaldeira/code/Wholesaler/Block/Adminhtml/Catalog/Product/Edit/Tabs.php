...
class Acaldeira_Wholesaler_Block_Adminhtml_Catalog_Product_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
     protected $_attributeTabBlock = 'wholesaler/adminhtml_catalog_product_edit_tab_attributes';
            ...
            foreach ($groupCollection as $group) {
                ...
                $this->addTab('group_'.$group->getId(), array(
                    ...
                    'content'   => $this->_translateHtml($this->getLayout()->createBlock($this->getAttributeTabBlock(),
                        'wholesaler.adminhtml.wcatalog.product.edit.tab.attributes')->setGroup($group)
